...
class WaylandIdleMonitor : public IIdleMonitor {
  public:
    ...
    bool init(int dim_ms, int screen_off_ms, int sleep_ms) override;
    void set_timeouts(int dim_ms, int screen_off_ms, int sleep_ms) override;
    void poll() override;
  ...
  private:
    ...
    bool create_notifications(int dim_ms, int screen_off_ms, int sleep_ms);
    ...
    ext_idle_notification_v1* m_notif_screen_off = nullptr;
