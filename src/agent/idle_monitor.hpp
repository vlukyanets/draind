...
// Implementations: WaylandIdleMonitor
class IIdleMonitor {
  public:
    ...
    virtual bool init(int dim_ms, int screen_off_ms, int sleep_ms) = 0;

    // Update timeouts (e.g. after config reload).
    virtual void set_timeouts(int dim_ms, int screen_off_ms, int sleep_ms) = 0;
